...
function TimeCountDown() {
    ...
    const { days, hours, minutes, seconds } = useCountdown(
        "February 11, 2026 6:00:00",
      );
  const formatNumber = (num) => String(num).padStart(2, "0");

  return (
    <section className="w-full py-12  mx-auto ">
        <h1 className="mb-4 text-center text-[clamp(2rem,5vw,3rem)] font-bold font-['Space_Grotesk',Inter,sans-serif] bg-[linear-gradient(135deg,#4aacd3_0%,#ffdf42_50%,#513c97_100%)] bg-clip-text text-transparent">Hackathon Project Submission Ends In</h1>
